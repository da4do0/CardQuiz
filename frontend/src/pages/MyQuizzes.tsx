  ...
  const fetchMyQuizzes = async () => {
    ...
    try {
      ...
      const userQuizzes = response.quizzes.map((quiz: any) => ({
        ...quiz,
        data: new Date(quiz.data), // Convert date string to Date object
        category: 'General' // Default category since it's not in database yet
      }));
    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/80 text-lg">Manage and track your created quizzes</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="card text-center">
            ...
            <div className="text-2xl font-bold text-white mb-1">{quizzes.length}</div>
        ...
        {quizzes.length === 0 ? (
          <div className="card text-center py-16">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">No Quizzes Yet</h3>
            <p className="text-white/70 mb-8 max-w-md mx-auto">
              You haven't created any quizzes yet. Start by creating your first quiz to engage your audience!
            </p>
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-white/80 text-sm leading-relaxed line-clamp-3">
                      A quiz with {quiz.questions?.length || 0} questions
                    </p>
                  </div>
                  ...
                  {/* Quiz Stats */}
                  <div className="flex justify-between items-center mb-6 p-3 bg-white/5 rounded-lg border border-white/10">
